...
echo "✅ Setup complete!"
echo "➡️ Next Steps:"
echo "1️⃣ Run Free5GC: cd free5gc && ./run.sh"
echo "2️⃣ Run UERANSIM"
echo "3️⃣ Run Prometheus: cd prometheus-2.41.0.linux-amd64 && sudo ./prometheus --config.file=prometheus.yaml --storage.tsdb.retention.time=10y"
echo "4️⃣ Run NWDAF: cd mnc_NWDAF-main/NWDAF && go run nwdaf.go"
