...
func handleNGSetupRequestMain(ran *context.AmfRan,
	...
	if cause.Present == ngapType.CausePresentNothing {
		// service.GnbConnectedCounter.WithLabelValues().Inc()
...
func handlePDUSessionResourceSetupResponseMain(ran *context.AmfRan,
	...
	if pDUSessionResourceSetupResponseList != nil {
		callback.SendEventNotification(amfUe, models.AmfEventType_REGISTRATION_STATE_REPORT, true)
		// callback.SendEventNotification(amfUe, models.AmfEventType_LOCATION_REPORT)
		callback.SendEventNotification(amfUe, models.AmfEventType_CONNECTIVITY_STATE_REPORT)
		// callback.SendEventNotification(amfUe, models.AmfEventType_REACHABILITY_REPORT)
		// callback.SendEventNotification(amfUe, models.AmfEventType_ACCESS_TYPE_REPORT)

		logger.NgapLog.Info("Event notification started")
